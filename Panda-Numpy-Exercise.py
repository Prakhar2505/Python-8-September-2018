...
if True:
    data = {'year': [2010, 2011, 2012, 2011, 2012, 2010, 2011, 2012],
            ...
            'losses': [5, 8, 6, 1, 5, 10, 6, 12]}
    football = pd.DataFrame(data)
    print(football.dtypes) # will return the datatype of all the columns e.g. year int64
    print() # print blank space
    print(football.describe()) # display the whole data frame (only applicable to numeric column)
    # display count, mean, standard deviation, min, 25%, 50%, 75%, max
    print() # print blank space
    print(football.head()) #
    print()
    print(football.tail())
